#Use the features provided by Zhan Fuxiang. Eg: batch_001.

#Before use, create an output folder.
...
def parse_args():
    ...
    parser.add_argument('--dim_feat', dest='dim_feat', help='The dimension of extracted ResNet101 features', default=4096)
...
if __name__ == "__main__":
    ...
    data_path = osp.join(args.dad_dir, 'features')  # /data/DAD/features####this feature is CHAN FU XIANG'feature eg:batch_001
    video_path = osp.join(args.dad_dir, 'videos')   # /data/DAD/videos####eg:rgb_mp4#####eg:flow_mp4
    run(data_path, video_path, args.out_dir)        # out: /data/DAD/flow_vgg16_features###先建立文件夹
